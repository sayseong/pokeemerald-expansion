...
- [过场配置](https://github.com/rh-hideout/pokeemerald-expansion/blob/master/include/config/overworld.h)
...
## 升级的战斗引擎
  ...
  - 昵称、努力值（EVs）、个体值（IVs）、招式、特性、精灵球、亲密度、性格、性别、闪光。
  - 自定义双打对战支持（与NPC组队）。
  - 中途的训练家信息。
  - 升级后的训练家AI
    - 考虑了最新的招式效果。
  ...
  - [过场调试](https://github.com/TheXaman/pokeemerald/tree/tx\_debug\_system)由@TheXaman制作
    - 可禁用。
    - 默认情况下，在过场画面中按`R + Start`键访问。
    - ‌**附加功能**‌：
        - *清空盒子*：清空所有盒子中的宝可梦。
        - *孵化蛋*：选择队伍中的一颗蛋并立即孵化。
  - [HGSS风格宝可梦图鉴](https://github.com/TheXaman/pokeemerald/tree/tx\_pokedexPlus\_hgss)由@TheXaman制作
    - 可禁用。
    - ‌**附加功能**‌：
        - *支持新的进化方式*。
        - *暗色模式*。
  - [特性颜色](https://github.com/DizzyEggg/pokeemerald/tree/nature\_color)摘要屏幕由@DizzyEggg制作
