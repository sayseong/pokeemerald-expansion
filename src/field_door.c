...
static const u8 sDoorNullPalette7[16] = {};
...
static const u8 sDoorAnimTiles_PlayerRoom[] = INCBIN_U8("graphics/door_anims/unused_battle_frontier.4bpp");
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Petalburg_Door_PlayerRoom   ,                   DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_PlayerRoom, sDoorAnimPalettes_PlayerRoom},
