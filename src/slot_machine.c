...
static const u8 sText_YouveGot9999Coins[] = _("代币已经达到9999枚了。");
static const u8 sText_YouveRunOutOfCoins[] = _("代币用完了。\n游戏结束！");
static const u8 sText_YouDontHaveThreeCoins[] = _("代币不足3枚。");
