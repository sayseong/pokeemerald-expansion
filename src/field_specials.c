...
static const u8 sText_Wallace[] = _("米可利");
static const u8 sText_Steven[] = _("大吾");
static const u8 sText_Brawly[] = _("藤树");
static const u8 sText_Winona[] = _("娜琪");
static const u8 sText_Phoebe[] = _("芙蓉");
static const u8 sText_Glacia[] = _("波妮");
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    {
        COMPOUND_STRING("飞吻海报{CLEAR_TO 94}16BP"),
        COMPOUND_STRING("亲吻坐垫{CLEAR_TO 94}32BP"),
        COMPOUND_STRING("迷唇娃玩偶{CLEAR_TO 94}32BP"),
        COMPOUND_STRING("波克比玩偶{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("喵喵玩偶{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("皮皮玩偶{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("百变怪{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("火球鼠玩偶{CLEAR_TO 94}80BP"),
        COMPOUND_STRING("菊草叶玩偶{CLEAR_TO 94}80BP"),
        COMPOUND_STRING("小锯鳄玩偶{CLEAR_TO 94}80BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_2] =
    {
        COMPOUND_STRING("拉普拉斯玩偶{CLEAR_TO 88}128BP"),
        COMPOUND_STRING("卡比兽玩偶{CLEAR_TO 88}128BP"),
        COMPOUND_STRING("妙蛙花玩偶{CLEAR_TO 88}256BP"),
        COMPOUND_STRING("喷火龙玩偶{CLEAR_TO 88}256BP"),
        COMPOUND_STRING("水箭龟玩偶{CLEAR_TO 88}256BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR] =
    {
        COMPOUND_STRING("攻击增强剂{CLEAR_TO 100}1BP"),
        COMPOUND_STRING("特攻增强剂{CLEAR_TO 100}1BP"),
        COMPOUND_STRING("防御增强剂{CLEAR_TO 100}1BP"),
        COMPOUND_STRING("特防增强剂{CLEAR_TO 100}1BP"),
        COMPOUND_STRING("速度增强剂{CLEAR_TO 100}1BP"),
        COMPOUND_STRING("HP增强剂{CLEAR_TO 100}1BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR] =
    {
        COMPOUND_STRING("吃剩的东西{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("白色香草{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("先制之爪{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("心灵香草{CLEAR_TO 94}48BP"),
        COMPOUND_STRING("光粉{CLEAR_TO 94}64BP"),
        COMPOUND_STRING("讲究头带{CLEAR_TO 94}64BP"),
        COMPOUND_STRING("王者之证{CLEAR_TO 94}64BP"),
        COMPOUND_STRING("气势头带{CLEAR_TO 94}64BP"),
        COMPOUND_STRING("焦点镜{CLEAR_TO 94}64BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BERRY_POWDER_VENDOR] =
    {
        ...
        COMPOUND_STRING("攻击增强剂{CLEAR_TO 99}{FONT_SMALL}1000"),
        COMPOUND_STRING("防御增强剂{CLEAR_TO 99}{FONT_SMALL}1000"),
        COMPOUND_STRING("速度增强剂{CLEAR_TO 99}{FONT_SMALL}1000"),
        COMPOUND_STRING("特攻增强剂{CLEAR_TO 99}{FONT_SMALL}1000"),
        COMPOUND_STRING("特防增强剂{CLEAR_TO 99}{FONT_SMALL}1000"),
        COMPOUND_STRING("HP增强剂{CLEAR_TO 99}{FONT_SMALL}1000"),
        COMPOUND_STRING("PP提升剂{CLEAR_TO 99}{FONT_SMALL}3000"),
        gText_Exit
    },
    ...
    {
        COMPOUND_STRING("生蛋{CLEAR_TO 78}16BP"),
        COMPOUND_STRING("地球上投{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("食梦{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("百万吨重拳{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("百万吨重踢{CLEAR_TO 78}48BP"),
        COMPOUND_STRING("泰山压顶{CLEAR_TO 78}48BP"),
        COMPOUND_STRING("岩崩{CLEAR_TO 78}48BP"),
        COMPOUND_STRING("双倍奉还{CLEAR_TO 78}48BP"),
        COMPOUND_STRING("电磁波{CLEAR_TO 78}48BP"),
        COMPOUND_STRING("剑舞{CLEAR_TO 78}48BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_MOVE_TUTOR_2] =
    {
        COMPOUND_STRING("变圆{CLEAR_TO 78}16BP"),
        COMPOUND_STRING("打鼾{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("掷泥{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("高速星星{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("冰冻之风{CLEAR_TO 78}24BP"),
        COMPOUND_STRING("挺住{CLEAR_TO 78}48BP"),
        COMPOUND_STRING("自我暗示{CLEAR_TO 78}48BP"),
        COMPOUND_STRING("冰冻拳{CLEAR_TO 78}48BP"),
        COMPOUND_STRING("雷电拳{CLEAR_TO 78}48BP"),
        COMPOUND_STRING("火焰拳{CLEAR_TO 78}48BP"),
        gText_Exit
    },
...
static const u8 sText_NowOn[] = _("当前：");
