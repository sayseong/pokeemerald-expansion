...
const u8 gText_UnkHeightMetric[] = _("")
const u8 gText_UnkWeight[] = _("？？？.？kg")
const u8 gText_UnkWeightMetric[] = _("")
...
const u8 gText_IdNumberSlash[] = _("IDNo. / // Unused") // Unused
...
const u8 gText_SendWhichMonToPC[] = _("")
...
const u8 gText_AM[] = _("")
const u8 gText_PM[] = _("")
const u8 gText_Relearn[] = _("") // future note: don't decap this, because it mimics the summary screen BG graphics which will not get decapped
const u8 gText_Rename[] = _("")
const u8 gText_CannotSendMonToBoxHM[] = _("")
