...
const u8 gText_关都地区[]=   _("                        关都地区                \n上一页(无)                             下一页(L)");
const u8 gText_城都地区[]=   _("                        城都地区                \n上一页(R)                               下一页(L)");
const u8 gText_丰源地区[]=   _("                        丰源地区                \n上一页(R)                               下一页(L)");
const u8 gText_神奥地区[]=   _("                        神奥地区                \n上一页(R)                               下一页(L)");
const u8 gText_合众地区[]=   _("                        合众地区                \n上一页(R)                               下一页(L)");
const u8 gText_卡洛斯地区[]= _("                      卡洛斯地区                \n上一页(R)                               下一页(L)");
const u8 gText_阿罗拉地区[]= _("                      阿罗拉地区                \n上一页(R)                               下一页(L)");
const u8 gText_伽勒尔地区[]= _("                      伽勒尔地区                \n上一页(R)                               下一页(L)");
const u8 gText_帕底亚地区[]= _("                      帕底亚地区                \n上一页(R)                             下一页(无)");