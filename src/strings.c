...
ALIGNED(4) const u8 gText_EndedWithXUnitsPowder[] = _("{PAUSE_MUSIC}{PLAY_BGM MUS_LEVEL_UP}您最终获得{STR_VAR_1}单位\n圆滑的树果粉末。{RESUME_MUSIC}\p您树果粉末的\n总数是{STR_VAR_2}。\p");
...
ALIGNED(4) const u8 gText_CommunicationStandby2[] = _("等待连接中……");
...
ALIGNED(4) const u8 gText_CrushingResults[] = _("混合成绩");
...
const u8 gText_CommunicationStandby3[] = _("等待连接中……");
...
const u8 gText_CommunicationStandby4[] = _("等待连接中……");
...
const u8 gText_CommunicationStandby5[] = _("等待连接中……");
...
const u8 gText_关都地区[]=   _("     关都地区    L");
const u8 gText_城都地区[]=   _("R    城都地区    L");
const u8 gText_丰源地区[]=   _("R    丰源地区    L");
const u8 gText_神奥地区[]=   _("R    神奥地区    L");
const u8 gText_合众地区[]=   _("R    合众地区    L");
const u8 gText_卡洛斯地区[]= _("R   卡洛斯地区   L");
const u8 gText_阿罗拉地区[]= _("R   阿罗拉地区   L");
const u8 gText_伽勒尔地区[]= _("R   伽勒尔地区   L");
const u8 gText_帕底亚地区[]= _("R   帕底亚地区    ");