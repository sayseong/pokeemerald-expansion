...
ALIGNED(4) const u8 gText_RecordingGameResults[] = _("正在将您的结果写入记录，\n请稍候。");
...
const u8 gText_BattlePalaceDesc[] = _("注视您的宝可梦战斗！\n这里将会考验您的精神。");
...
ALIGNED(4) const u8 gText_RecordUploadedViaWireless[] = _("您的记录已用无线通信更新。");
