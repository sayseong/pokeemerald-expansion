...
ALIGNED(4);
const u8 gText_ExpandedPlaceholder_Empty[] = _("nan");
const u8 gText_ExpandedPlaceholder_Kun[] = _("nan");
const u8 gText_ExpandedPlaceholder_Chan[] = _("nan");
...
const u8 gText_DexEmptyString[] = _("nan");
...
const u8 gText_EmptyString2[] = _("nan");
...
const u8 gText_IDNumber2[] = _("IDNo.");
...
const u8 gText_EmptyString5[] = _("nan");
...
const u8 gText_PokemonNature[] = _("精灵类型");
const u8 gText_PokemonMoves[] = _("精灵招式");
const u8 gText_Underpowered[] = _("失去战斗力");
const u8 gText_WhenInDanger[] = _("在危险时");
const u8 gText_BattlePokemon[] = _("对战精灵");
const u8 gText_BattleTrainers[] = _("对战训练师");
...
const u8 gText_YourPartysFull[] = _("持有精灵满了！{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TheTrainersImage[] = _("这个训练师的形象。");
...
const u8 gText_StopGivingPkmnMail[] = _("停止给予精灵邮件吗?");
...
const u8 gText_StopGivingPkmnMail2[] = _("停止给予精灵邮件吗?"); // Unused
...
const u8 gText_QuestionPressTheAButton[] = _("请按Ａ键。");
...
const u8 gText_PokemonLeague[] = _("精灵联盟");
const u8 gText_PokemonCenter[] = _("精灵中心");
...
const u8 gText_EmptyString6[] = _("nan");
...
const u8 gText_HealthboxNickname[] = _("nan");
...
const u8 gText_HealthboxGender_None[] = _("nan");
...
const u8 gText_EmptyString7[] = _("nan");
...
const u8 gText_1Colon[] = _("01:00:00");
...
const u8 gText_FrameTypeNumber[] = _("nan");
...
const u8 gText_MenuPokedex[] = _("{POKE_DEX_ICON}图鉴");
const u8 gText_MenuPokemon[] = _("{POKEMON_ICON}宝可梦");
const u8 gText_MenuBag[] = _("{BAG_ICON_ICON}背包");
const u8 gText_MenuPokenav[] = _("{POKENAV_ICON}领航员");
const u8 gText_MenuPlayer[] = _("{PLAYER_ICON}{PLAYER}");
const u8 gText_MenuSave[] = _("{SAVE_ICON}保存");
const u8 gText_MenuOption[] = _("{OPTION_ICON}设置");
const u8 gText_MenuExit[] = _("{EXIT_ICON}退出");
...
const u8 gText_TeachWhichMoveToPkmn[] = _("要让{STR_VAR_1}学习哪个技能呢?");
