...
const u8 gText_UnkHeight[] = _("{CLEAR_TO 12}???.?m");
...
const u8 gText_EmptyHeight[] = _("{CLEAR_TO 12}    .    m"); // Unused
...
const u8 gText_MoveRelearnerTeachMoveConfirmUseTm[] = _("要学习{STR_VAR_2}吗？\n这将消耗一个{STR_VAR_3}。");
...
const u8 gText_MoveRelearnerStop[] = _("要停止让{STR_VAR_1}学习\n新招式吗？");
