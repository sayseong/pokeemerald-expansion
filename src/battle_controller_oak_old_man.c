...
static const u8 sText_ForPetesSake[] = _("大木博士：哎呀呀，真是的……\n还是像以前一样急性子。\p{B_PLAYER_NAME}。\p你以前从来没有进行过\n宝可梦对战吧？\p所谓的宝可梦对战，就是训练家们\n让各自的宝可梦进行较量。\p");
static const u8 sText_HowDissapointing[] = _("大木博士：嗯……\n真是遗憾啊……\p如果你赢了，就能获得零用钱，\n宝可梦也会成长。\p但如果你输了，{B_PLAYER_NAME}，你就要\n支付给对方零用钱……\p不过，既然这次事发突然，\n我就替你付了吧。\p但只要你走出这扇大门，\n可就没这么走运了。\p所以你必须通过与野生宝可梦对战，\n来提升你宝可梦的实力。\p");
static const u8 sText_InflictingDamageIsKey[] = _("大木博士：在任何对战中，\n给对手造成伤害都是关键。\p");
static const u8 sText_KeepAnEyeOnHP[] = _("大木博士：要随时注意\n宝可梦的HP。\p如果HP归“0”，\n宝可梦就会倒下。\p");
static const u8 sText_LoweringStats[] = _("大木博士：降低对手的能力，\n会让你的处境更加有利。\p");
static const u8 sText_OakNoRunningFromATrainer[] = _("大木博士：不行！\n面对训练家的宝可梦对战，\l是不能逃跑的！\p");
static const u8 sText_TheTrainerThat[] = _("哪位训练家能通过削减HP，\n让对方的宝可梦全部倒下，\l哪位训练家就获胜了。\p");
static const u8 sText_TryBattling[] = _("不过，与其光听我说，\n不如亲身体会学得更快。\p去试试对战，亲身感受一下吧。\p");
static const u8 sText_WinEarnsPrizeMoney[] = _("大木博士：唔！做得好！\p如果你赢了，就能获得零用钱，\n宝可梦也会成长！\p去和其他训练家对战，\n让你的宝可梦变得更强吧！\p");
const u8 gText_WhatWillOldManDo[] = _("老爷爷该\n怎么办呢？");
