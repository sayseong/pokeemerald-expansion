...
{
    COMPOUND_STRING("无可争议的头号夺冠热门！"), 
    COMPOUND_STRING("锁定决赛席位的强劲之师。"),
    COMPOUND_STRING("挺进前三甲的有力争夺者。"),
    COMPOUND_STRING("具备问鼎冠军实力的劲旅。"),
    COMPOUND_STRING("坐拥顶尖水准的潜力战队。"),
    COMPOUND_STRING("本届大赛不容小觑的黑马。"),
    COMPOUND_STRING("实力位居平均线之上的队伍。"),
    COMPOUND_STRING("本届大赛中规中矩的队伍。"),
    COMPOUND_STRING("潜力平平、表现均衡的队伍。"),
    COMPOUND_STRING("实力略逊于平均水准的队伍。"),
    COMPOUND_STRING("苦求首胜突破的队伍。"),
    COMPOUND_STRING("恐怕一胜难求的队伍。"),
    COMPOUND_STRING("整体实力偏弱的队伍。"),
    COMPOUND_STRING("上限极为有限的队伍。"),
    COMPOUND_STRING("几无夺冠可能的队伍。"),
    COMPOUND_STRING("本届大赛中胜率垫底的队伍。"), 
    COMPOUND_STRING("完美无瑕、所向披靡的超级巨星！"), 
};
...
{
    [DOME_BATTLE_STYLE_RISKY]           = COMPOUND_STRING("时而甘愿孤注一掷。"),
    [DOME_BATTLE_STYLE_STALL]           = COMPOUND_STRING("擅长消磨对手的持久战。"),
    [DOME_BATTLE_STYLE_VARIED]          = COMPOUND_STRING("看穿对手，灵活变幻战术。"),
    [DOME_BATTLE_STYLE_COMBO_HIGH]      = COMPOUND_STRING("深谙克敌制胜之道。"), 
    [DOME_BATTLE_STYLE_RARE_MOVES]      = COMPOUND_STRING("偶尔会使出极为罕见的招式。"),
    [DOME_BATTLE_STYLE_RARE_MOVE]       = COMPOUND_STRING("招式出其不意，打乱对战节奏。"),
    [DOME_BATTLE_STYLE_HP]              = COMPOUND_STRING("在对战中时刻戒备HP。"),
    [DOME_BATTLE_STYLE_STORE_POWER]     = COMPOUND_STRING("蓄势待发，伺机爆发强力一击。"),
    [DOME_BATTLE_STYLE_ENFEEBLE_LOW]    = COMPOUND_STRING("精于削弱对手的实力。"),
    [DOME_BATTLE_STYLE_LUCK]            = COMPOUND_STRING("倾向于寄希望于运气的战术。"),
    [DOME_BATTLE_STYLE_REGAL]           = COMPOUND_STRING("攻势中隐隐透着王者风范。"),
    [DOME_BATTLE_STYLE_LOW_PP]          = COMPOUND_STRING("倾向于凭强力且低PP的招式强攻。"),
    [DOME_BATTLE_STYLE_STATUS_ATK]      = COMPOUND_STRING("擅长在削弱对手后展开猛攻。"),
    [DOME_BATTLE_STYLE_ENDURE]          = COMPOUND_STRING("任凭对手狂轰滥炸也绝不倒下。"),
    [DOME_BATTLE_STYLE_STATUS]          = COMPOUND_STRING("擅长扰乱敌方心智。"),
    [DOME_BATTLE_STYLE_STRAIGHTFORWARD] = COMPOUND_STRING("招式强劲，正面突破。"),
    [DOME_BATTLE_STYLE_AGGRESSIVE]      = COMPOUND_STRING("攻势凶猛，频频施展强力招式。"),
    [DOME_BATTLE_STYLE_DEF]             = COMPOUND_STRING("身法轻盈，巧避攻击的同时进行对战。"),
    [DOME_BATTLE_STYLE_ENFEEBLE_HIGH]   = COMPOUND_STRING("擅长施展让对手陷入被动的攻势。"),
    [DOME_BATTLE_STYLE_POPULAR_POWER]   = COMPOUND_STRING("熟练运用诸多深受青睐的招式。"),
    [DOME_BATTLE_STYLE_COMBO_LOW]       = COMPOUND_STRING("掌握着能打出强力连携的招式。"),
    [DOME_BATTLE_STYLE_ACCURATE]        = COMPOUND_STRING("攻势沉稳，追求高命中率。"),
    [DOME_BATTLE_STYLE_POWERFUL]        = COMPOUND_STRING("攻势凌厉，频频施展华丽招式。"),
    [DOME_BATTLE_STYLE_ATK_OVER_DEF]    = COMPOUND_STRING("攻势凌厉，崇尚进攻胜过防守。"),
    [DOME_BATTLE_STYLE_DEF_OVER_ATK]    = COMPOUND_STRING("壁垒森严，崇尚防守胜过进攻。"),
    [DOME_BATTLE_STYLE_POPULAR_STRONG]  = COMPOUND_STRING("攻势迅猛，凭强力招式速战速决。"),
    [DOME_BATTLE_STYLE_EFFECTS]         = COMPOUND_STRING("频频使出带有追加效果的招式。"),
    [DOME_BATTLE_STYLE_BALANCED]        = COMPOUND_STRING("招式搭配均衡，毫无破绽。"),
    [DOME_BATTLE_STYLE_UNUSED1]         = COMPOUND_STRING("此为测试文本1。"),
    [DOME_BATTLE_STYLE_UNUSED2]         = COMPOUND_STRING("此为测试文本2。"),
    [DOME_BATTLE_STYLE_UNUSED3]         = COMPOUND_STRING("此为测试文本3。"),
    [DOME_BATTLE_STYLE_UNUSED4]         = COMPOUND_STRING("此为测试文本4。"),
};
...
static const u8 *const sBattleDomeOpponentStatsTexts[] =
{
    ...
    [DOME_TEXT_WELL_BALANCED] = COMPOUND_STRING("以非常均衡的方式培育宝可梦。"),
};
