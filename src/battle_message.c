...
static const u8 sText_WildPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME}出现了！\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME}出现了！\p");
static const u8 sText_WildPkmnAppearedPause[] = _("{B_OPPONENT_MON1_NAME}出现了！{PAUSE 127}");
...
static const u8 sText_PkmnSwitchOut[] = _("{B_BUFF1}，替换了！\n回来吧！"); //currently unused, I believe its used for when you switch on a pokemon in shift mode
static const u8 sText_PkmnThatsEnough[] = _("{B_BUFF1}，好！\n回来吧！");
