...
static const u8 sText_WildPkmnAppearedPause[] = _("{B_OPPONENT_MON1_NAME}扑过来了！\p");
...
static const u8 sText_GoPkmn2[] = _("上吧！{B_PLAYER_MON1_NAME}！");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNLEARNEDMOVE2]                     = COMPOUND_STRING("{B_BUFF1}\n学会了{B_BUFF2}！{WAIT_SE}\p"),
    ...
    [STRINGID_PLAYERWHITEOUT2]                      = COMPOUND_STRING("{B_PLAYER_NAME}的手上没有\n可以战斗的宝可梦！\p"),
#else
    [STRINGID_PLAYERWHITEOUT2]                      = COMPOUND_STRING("{B_PLAYER_NAME}的手上没有\n可以战斗的宝可梦！\p"),
#endif
    ...
    [STRINGID_PKMNALREADYASLEEP2]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\n已经睡着了！"),
    ...
    [STRINGID_PKMNWASDEFROSTED2]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\n冰冻被融化了！"),
    [STRINGID_PKMNWASDEFROSTEDBY]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\n冰冻被融化了！"),
    [STRINGID_PKMNWASPARALYZED]                     = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}麻痹了，\n很难使出招式！"),
    [STRINGID_PKMNWASPARALYZEDBY]                   = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}麻痹了，\n很难使出招式！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNPROTECTEDITSELF2]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}\n在攻击中守护住了自己！"),
    ...
    [STRINGID_PKMNWOKEUPINUPROAR]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n醒过来了！"),
    ...
    [STRINGID_PKMNHURTBYSPIKES]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}受到了\n{B_BUFF1}的伤害。"),
    ...
    [STRINGID_PKMNCHANGEDTYPEWITH]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n变成了{B_BUFF1}属性！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSXBLOCKSY2]                       = COMPOUND_STRING("因为{B_DEF_ABILITY}，{B_DEF_NAME_WITH_PREFIX}\n抵御了{B_CURRENT_MOVE}!"), //not in gen 5+, ability popup
    [STRINGID_PKMNSXWOREOFF]                        = COMPOUND_STRING("{B_ATK_TEAM1}的{B_BUFF1}消失了！"),
    [STRINGID_PKMNRAISEDDEFALITTLE]                 = COMPOUND_STRING("反射壁使{B_ATK_TEAM2}的\n物理抗性提高了！"), //expansion doesn't use anymore
    [STRINGID_PKMNRAISEDSPDEFALITTLE]               = COMPOUND_STRING("光墙使{B_ATK_TEAM2}的\n特殊抗性提高了！"), //expansion doesn't use anymore
    ...
    [STRINGID_PKMNOBTAINEDX2]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}\n获得了{B_BUFF1}！"),
    ...
    [STRINGID_PKMNMOVEBOUNCEDABILITY]               = COMPOUND_STRING("将{B_EFF_NAME_WITH_PREFIX}的\n{B_CURRENT_MOVE}反射了回去！"),
    ...
    [STRINGID_EXTREMELYHARSHSUNLIGHTWASNOTLESSENED] = COMPOUND_STRING("日照变得非常强了！"),
    [STRINGID_HEAVYRAIN]                            = COMPOUND_STRING("开始下起了暴雨！"),
    [STRINGID_HEAVYRAINLIFTED]                      = COMPOUND_STRING("开始下起了暴雨！"),
    ...
    [STRINGID_MYSTERIOUSAIRCURRENTBLOWSON]          = COMPOUND_STRING("神秘的乱流\n保护着飞行属性宝可梦！"),
    ...
    [STRINGID_CANTESCAPEDUETOUSEDMOVE]              = COMPOUND_STRING("无法逃走！\p"),
    ...
    [STRINGID_CANTESCAPEBECAUSEOFCURRENTMOVE]       = COMPOUND_STRING("无法逃走！\p"),
    ...
    [STRINGID_PKMNHURTBYFROSTBITE]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}受到了\n{B_BUFF1}的伤害。"),
    ...
    [STRINGID_PKMNFROSTBITEHEALED2]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\n冻伤痊愈了！"),
    [STRINGID_PKMNFROSTBITEHEALEDBY]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}的\n冻伤痊愈了！"),
    ...
    [STRINGID_PKMNHURTBYVINES]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}受到了\n{B_BUFF1}的伤害。"),
    [STRINGID_TEAMCAUGHTINVORTEX]                   = COMPOUND_STRING("{B_DEF_TEAM1}宝可梦\n被困在水流之中！"),
    [STRINGID_PKMNHURTBYVORTEX]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}受到了\n{B_BUFF1}的伤害。"),
    ...
    [STRINGID_PKMNHURTBYROCKSTHROWN]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}受到了\n{B_BUFF1}的伤害。"),
    ...
    [STRINGID_SUPEREFFECTIVETWOFOES]                = COMPOUND_STRING("效果绝佳！"),
    [STRINGID_NOTVERYEFFECTIVETWOFOES]              = COMPOUND_STRING("好像效果不好……"),
    [STRINGID_ITDOESNTAFFECTTWOFOES]                = COMPOUND_STRING("对于{B_DEF_NAME_WITH_PREFIX2}，\n好像没有效果……"),
...
const u8 gText_WhatWillPkmnDo2[] = _("{B_BUFF1}\n要做什么呢？");
...
const u8 gText_MoveInterfacePpType[] = _("PP");
...
const u8 gText_BattleSwitchWhich2[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}与哪个招式\n交换位置?");
const u8 gText_BattleSwitchWhich3[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}与哪个招式\n交换位置?");
const u8 gText_BattleSwitchWhich4[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}与哪个招式\n交换位置?");
const u8 gText_BattleSwitchWhich5[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}与哪个招式\n交换位置?");
