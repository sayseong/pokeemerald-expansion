...
const struct Berry gBerries[] =
{
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("鲜红色的果实非常辣，带着些刺激"),
    ...
    [ITEM_ASPEAR_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("味是其特色。"),
        .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_LEPPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("度较为缓慢。越小的果实口味越佳"),
    ...
    [ITEM_ORAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("中迸发出各种奇妙的好滋味。"),
    ...
    [ITEM_LUM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("这种树果会在身内储存对宝可梦有"),
        .description2 = COMPOUND_STRING("益的成分，因此需要长时间成熟。"),
    ...
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("原本跟橙橙果属于同类，之后才区"),
    ...
    [ITEM_WEPEAR_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("胃消化。会开出美丽的白色花朵。"),
        .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_KELPSY_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("水煮干，其精华可为料理增添一味"),
        .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_GREPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("和甜味立刻扩散至整个口中。"),
        .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 10,
    ...
    [ITEM_RABUTA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("能清洁肠胃，建议宝可梦连皮吃下"),
        .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_NOMEL_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("别集中于尖端的部位。"),
        .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_PAMTRE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("在神奥地区已经能够栽培这种树果。"),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 0,
        .dry = 40,
        .sweet = 10,
    ...
    [ITEM_WATMEL_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 15, 15, 15),
        .minYield = YIELD_RATE(1, 2, 3, 3),
        .description1 = COMPOUND_STRING("口味极甘甜，如大自然的恩惠。且"),
        .description2 = COMPOUND_STRING("非常大，曾有人发现50厘米的果实"),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 40,
    ...
    [ITEM_BELUE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("很美味，但吃一口才发现其实很酸"),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_KEBIA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("外观呈现鲜艳的绿色，但切开来看"),
    ...
    [ITEM_SHUCA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("觉到硬度和香味。"),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 10,
        .dry = 0,
        .sweet = 15,
    ...
    [ITEM_COBA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("了一起，从而繁殖结成的新品种。"),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_PAYAPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("胀成圆形，因此有人说它会读人心"),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_TANGA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("出的花瓣，以此来吸引虫宝可梦。"),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 20,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_HABAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("去苦味，因此也适合做成果酱。"),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_COLBUR_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("生于表面的小型刺状物让它能附在"),
        .description2 = COMPOUND_STRING("宝可梦身上，随其去遥远的地方。"),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_BABIRI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("的人会把它用作制药的材料。"),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 25,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_LIECHI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("言说，它蕴藏着大海的力量。"),
    ...
    [ITEM_GANLON_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("言说，它蕴藏着大地的力量。"),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 0,
        .dry = 40,
        .sweet = 0,
    ...
    [ITEM_SALAC_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("言说，它蕴藏着天空的力量。"),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 0,
        .dry = 0,
        .sweet = 40,
    ...
    [ITEM_MICLE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 5, 13),
        .minYield = YIELD_RATE(1, 1, 1, 1),
        .description1 = COMPOUND_STRING("本身的味道非常涩，但如果和其他"),
    ...
    [ITEM_CUSTAP_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("则像奶油一样又甜又柔软。"),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
        .spicy = 0,
        .dry = 0,
        .sweet = 40,
    ...
    [ITEM_ROWAP_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("个的陀螺。以前的人会把它当玩具"),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_KEE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description2 = COMPOUND_STRING("后袭来的，是猛烈无比的涩味。"),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 30,
        .dry = 30,
        .sweet = 10,
