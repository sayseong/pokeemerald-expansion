...
static const u8 sText_Relearn[] = _("{START_BUTTON}回忆"); // future note: don't decap this, because it mimics the summary screen BG graphics which will not get decapped

static const u8 *const sRelearnTexts[MOVE_RELEARNER_COUNT] =
{
    [MOVE_RELEARNER_LEVEL_UP_MOVES] = COMPOUND_STRING("{START_BUTTON}回忆升级招式"),
    [MOVE_RELEARNER_EGG_MOVES] =      COMPOUND_STRING("{START_BUTTON}回忆蛋招式"),
    [MOVE_RELEARNER_TM_MOVES] =       COMPOUND_STRING("{START_BUTTON}回忆学习器招式"),
    [MOVE_RELEARNER_TUTOR_MOVES] =    COMPOUND_STRING("{START_BUTTON}回忆教授招式"),
};
