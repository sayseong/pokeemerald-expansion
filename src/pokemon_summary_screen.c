...
static const u8 sText_Relearn_LevelUp[] = _("{START_BUTTON}回忆升级招式");
static const u8 sText_Relearn_Egg[] = _("{START_BUTTON}回忆蛋招式");
static const u8 sText_Relearn_TM[] = _("{START_BUTTON}回忆学习器招式");
static const u8 sText_Relearn_Tutor[] = _("{START_BUTTON}回忆教授招式");
