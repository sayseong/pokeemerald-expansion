...
// Easy Chat keyboard
const u8 gText_EasyChatKeyboard_ABCDEFothers[] = _("{CLEAR 11}A{CLEAR 6}B{CLEAR 6}C{CLEAR 26}D{CLEAR 6}E{CLEAR 6}F{CLEAR 26}其他");
...
const struct PingYinSerchNode gPingYinSerchNode[416] =
{
