...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_MOVE_ITEM] = {COMPOUND_STRING("传递"), CursorCb_MoveItem},
    ...
    [MENU_LEVEL_UP_MOVES]  = {COMPOUND_STRING("升级招式"),     CursorCb_ChangeLevelUpMoves},
	[MENU_EGG_MOVES]       = {COMPOUND_STRING("蛋招式"),       CursorCb_ChangeEggMoves},
	[MENU_TM_MOVES]        = {COMPOUND_STRING("学习器招式"),        CursorCb_ChangeTMMoves},
	[MENU_TUTOR_MOVES]     = {COMPOUND_STRING("教授招式"),     CursorCb_ChangeTutorMoves},
